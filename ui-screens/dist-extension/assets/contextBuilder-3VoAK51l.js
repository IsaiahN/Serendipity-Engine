...
`)}`}]}}async function c(e){return e?.series?r(await n(e.series),e.id):``}function l(e,t,n){let r=t-n;if(e.reduce((e,t)=>e+i(t.content),0)<=r)return{messages:e,trimmed:!1,strategy:null};let a=e.map(e=>({...e})),o=null;for(let e of a)e.role===`assistant`&&i(e.content)>500&&(e.content=e.content.split(/\s+/).slice(0,150).join(` `)+`

[... trimmed for context ...]`);if(o=`trim-assistant`,a.reduce((e,t)=>e+i(t.content),0)<=r)return{messages:a,trimmed:!0,strategy:o};let s=a.filter(e=>e.role===`system`),c=a.filter(e=>e.role!==`system`);if(c.length>4&&(a=[...s,...c.slice(-4)],o=`drop-history`,a.reduce((e,t)=>e+i(t.content),0)<=r))return{messages:a,trimmed:!0,strategy:o};for(let e of a)if(e.role===`system`&&i(e.content)>r*.5){let t=e.content.length,n=Math.floor(t*.4),r=Math.floor(t*.2);e.content=e.content.slice(0,n)+`

[... context trimmed to fit model limit ...]

`+e.content.slice(t-r)}if(o=`truncate-system`,a.reduce((e,t)=>e+i(t.content),0)<=r)return{messages:a,trimmed:!0,strategy:o};for(;a.reduce((e,t)=>e+i(t.content),0)>r;){let e=0,t=0;a.forEach((n,r)=>{let a=i(n.content);a>t&&(t=a,e=r)});let n=a[e].content.split(/\s+/),r=Math.max(50,Math.floor(n.length*.6));if(a[e].content=n.slice(0,r).join(` `)+`

[... hard-trimmed to fit context ...]`,n.length<=60)break}return o=`hard-truncate`,{messages:a,trimmed:!0,strategy:o}}export{l as a,i,o as n,c as o,s as r,a as t};